...
(function () {
  ...
  var T = {
    ...
    'For most families, a home is the biggest decision they will ever make. I have never forgotten that.': {
      hi: 'ज़्यादातर परिवारों के लिए, घर खरीदना उनके जीवन का सबसे बड़ा फ़ैसला होता है। मैं यह बात कभी नहीं भूला।',
      gu: 'મોટાભાગના પરિવારો માટે, ઘર ખરીદવું એ તેમના જીવનનો સૌથી મોટો નિર્ણય હોય છે. હું આ વાત ક્યારેય ભૂલ્યો નથી.' },
    'Over the last ten years I have sat across the table from families who saved for years to get here, who were nervous, who had been told no by a bank, or who simply did not know where to start. I do not treat any of them like a deal to close. I treat the decision like it is my own family making it.': {
      hi: 'पिछले दस सालों में मैं ऐसे कई परिवारों के सामने बैठा हूँ जिन्होंने यहाँ तक पहुँचने के लिए सालों बचत की, जो घबराए हुए थे, जिन्हें बैंक ने मना कर दिया था, या जिन्हें बस यह नहीं पता था कि शुरुआत कहाँ से करें। मैं किसी को भी सिर्फ़ एक डील की तरह नहीं देखता। मैं हर फ़ैसले को ऐसे लेता हूँ जैसे यह मेरे अपने परिवार का फ़ैसला हो।',
      gu: 'છેલ્લા દસ વર્ષોમાં હું એવા ઘણા પરિવારોની સામે બેઠો છું જેમણે અહીં પહોંચવા માટે વર્ષો સુધી બચત કરી, જેઓ ગભરાયેલા હતા, જેમને બેંકે ના પાડી હતી, અથવા જેમને ખબર જ નહોતી કે ક્યાંથી શરૂઆત કરવી. હું કોઈને પણ ફક્ત એક ડીલ તરીકે નથી ગણતો. હું દરેક નિર્ણયને એ રીતે લઉં છું જાણે તે મારા પોતાના પરિવારનો નિર્ણય હોય.' },
    'That means telling you the truth. When the numbers are ready, no one will negotiate harder to get you the right home at the right price. And when they are not ready, I will tell you to wait, even though waiting earns me nothing. It is the only way I know how to do this work, and it is why so many of my clients send me their family and friends.': {
      hi: 'इसका मतलब है आपको सच बताना। जब आँकड़े सही हों, तो सही घर सही कीमत पर दिलाने के लिए मुझसे ज़्यादा सख़्ती से कोई मोलभाव नहीं करेगा। और जब वे सही न हों, तो मैं आपको रुकने के लिए कहूँगा, भले ही इससे मुझे कुछ न मिले। यही एक तरीक़ा है जो मैं जानता हूँ, और यही वजह है कि मेरे इतने ग्राहक अपने परिवार और दोस्तों को मेरे पास भेजते हैं।',
      gu: 'એનો અર્થ છે તમને સાચું કહેવું. જ્યારે આંકડા યોગ્ય હોય, ત્યારે યોગ્ય ઘર યોગ્ય કિંમતે અપાવવા માટે મારા કરતાં વધુ સખત મોલભાવ કોઈ નહીં કરે. અને જ્યારે તે યોગ્ય ન હોય, ત્યારે હું તમને રાહ જોવાનું કહીશ, ભલે તેમાં મને કંઈ ન મળે. કામ કરવાની આ જ એકમાત્ર રીત હું જાણું છું, અને એટલે જ મારા ઘણા ગ્રાહકો પોતાના પરિવાર અને મિત્રોને મારી પાસે મોકલે છે.' },
